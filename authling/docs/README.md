...
Authling maintains documentation independently from Chatto:
...
so this documentation can move with Authling when its temporary incubation in
this repository ends.
