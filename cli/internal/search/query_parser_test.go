...
func TestParseQuery(t *testing.T) {
	parsed, err := ParseQuery(`motherfucking AND search "exact phrase" in:"Team chat 💬" from:alice after:2025-01-01 before:2025-02-01 has:attachments`)
	...
	require.Equal(t, []string{"Team chat 💬"}, parsed.RoomSelectors)
