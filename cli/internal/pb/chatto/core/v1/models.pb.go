...
// WEBHOOK users back channel webhooks (FDR-035): they author messages but can
...
type MessageBody struct {
	...
	// Webhook per-message identity override (FDR-035). Present only for messages
...
// webhook caller may set on an individual post (FDR-035). When present, clients
