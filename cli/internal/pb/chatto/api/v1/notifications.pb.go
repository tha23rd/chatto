...
func (x *ReactionNotification) GetRoom() *RoomSummary {
	if x != nil {
		return x.Room
	}
	return nil
...
func (x *ReactionNotification) GetThreadRootEventId() string {
	if x != nil && x.ThreadRootEventId != nil {
		return *x.ThreadRootEventId
	}
	return ""
...
func (x *NotificationItem) GetReaction() *ReactionNotification {
	if x != nil {
		if x, ok := x.Kind.(*NotificationItem_Reaction); ok {
			return x.Reaction
		}
	}
	return nil
...
type NotificationItem_Reaction struct {
	// Reaction-to-your-message notification.
	Reaction *ReactionNotification `protobuf:"bytes,15,opt,name=reaction,proto3,oneof"`
}
...
func (*NotificationItem_Reaction) isNotificationItem_Kind() {}
...
const file_chatto_api_v1_notifications_proto_rawDesc = "" +
	...
	"\x04room\x18\x01 \x01(\v2\x1a.chatto.api.v1.RoomSummaryR\x04room\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\tR\aeventId\"\xed\x01\n" +
	"\x14ReactionNotification\x12.\n" +
	"\x04room\x18\x01 \x01(\v2\x1a.chatto.api.v1.RoomSummaryR\x04room\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\tR\aeventId\x12\x14\n" +
	"\x05emoji\x18\x03 \x01(\tR\x05emoji\x124\n" +
	"\x14thread_root_event_id\x18\x04 \x01(\tH\x00R\x11threadRootEventId\x88\x01\x01\x12%\n" +
	"\x0ereaction_count\x18\x05 \x01(\x05R\rreactionCountB\x17\n" +
	...
	"\acall_id\x18\x02 \x01(\tR\x06callId\"\xd9\x04\n" +
	...
	"\x12voice_call_started\x18\x0e \x01(\v2+.chatto.api.v1.VoiceCallStartedNotificationH\x00R\x10voiceCallStarted\x12A\n" +
	"\breaction\x18\x0f \x01(\v2#.chatto.api.v1.ReactionNotificationH\x00R\breactionB\x06\n" +
...
var file_chatto_api_v1_notifications_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_chatto_api_v1_notifications_proto_goTypes = []any{
	...
	(*ReactionNotification)(nil),               // 4: chatto.api.v1.ReactionNotification
	(*VoiceCallStartedNotification)(nil),       // 5: chatto.api.v1.VoiceCallStartedNotification
	...
	(*GetNotificationRequest)(nil),             // 10: chatto.api.v1.GetNotificationRequest
	(*GetNotificationResponse)(nil),            // 11: chatto.api.v1.GetNotificationResponse
	(*BatchGetNotificationsRequest)(nil),       // 12: chatto.api.v1.BatchGetNotificationsRequest
	(*BatchGetNotificationsResponse)(nil),      // 13: chatto.api.v1.BatchGetNotificationsResponse
	(*ListRoomNotificationsResponse)(nil),      // 14: chatto.api.v1.ListRoomNotificationsResponse
	(*HasNotificationsRequest)(nil),            // 15: chatto.api.v1.HasNotificationsRequest
	(*HasNotificationsResponse)(nil),           // 16: chatto.api.v1.HasNotificationsResponse
	(*RoomNotificationCount)(nil),              // 17: chatto.api.v1.RoomNotificationCount
	(*ListRoomNotificationCountsRequest)(nil),  // 18: chatto.api.v1.ListRoomNotificationCountsRequest
	(*ListRoomNotificationCountsResponse)(nil), // 19: chatto.api.v1.ListRoomNotificationCountsResponse
	(*DismissNotificationRequest)(nil),         // 20: chatto.api.v1.DismissNotificationRequest
	(*DismissNotificationResponse)(nil),        // 21: chatto.api.v1.DismissNotificationResponse
	(*DismissAllNotificationsRequest)(nil),     // 22: chatto.api.v1.DismissAllNotificationsRequest
	(*DismissAllNotificationsResponse)(nil),    // 23: chatto.api.v1.DismissAllNotificationsResponse
...
var file_chatto_api_v1_notifications_proto_depIdxs = []int32{
	24, // 0: chatto.api.v1.DirectMessageNotification.room:type_name -> chatto.api.v1.RoomSummary
	24, // 1: chatto.api.v1.MentionNotification.room:type_name -> chatto.api.v1.RoomSummary
	24, // 2: chatto.api.v1.ReplyNotification.room:type_name -> chatto.api.v1.RoomSummary
	24, // 3: chatto.api.v1.RoomMessageNotification.room:type_name -> chatto.api.v1.RoomSummary
	24, // 4: chatto.api.v1.ReactionNotification.room:type_name -> chatto.api.v1.RoomSummary
	24, // 5: chatto.api.v1.VoiceCallStartedNotification.room:type_name -> chatto.api.v1.RoomSummary
	25, // 6: chatto.api.v1.NotificationItem.created_at:type_name -> google.protobuf.Timestamp
	26, // 7: chatto.api.v1.NotificationItem.actor:type_name -> chatto.api.v1.User
	0,  // 8: chatto.api.v1.NotificationItem.direct_message:type_name -> chatto.api.v1.DirectMessageNotification
	1,  // 9: chatto.api.v1.NotificationItem.mention:type_name -> chatto.api.v1.MentionNotification
	2,  // 10: chatto.api.v1.NotificationItem.reply:type_name -> chatto.api.v1.ReplyNotification
	3,  // 11: chatto.api.v1.NotificationItem.room_message:type_name -> chatto.api.v1.RoomMessageNotification
	5,  // 12: chatto.api.v1.NotificationItem.voice_call_started:type_name -> chatto.api.v1.VoiceCallStartedNotification
	4,  // 13: chatto.api.v1.NotificationItem.reaction:type_name -> chatto.api.v1.ReactionNotification
	27, // 14: chatto.api.v1.ListNotificationsRequest.page:type_name -> chatto.api.v1.PageRequest
	27, // 15: chatto.api.v1.ListRoomNotificationsRequest.page:type_name -> chatto.api.v1.PageRequest
	6,  // 16: chatto.api.v1.ListNotificationsResponse.notifications:type_name -> chatto.api.v1.NotificationItem
	28, // 17: chatto.api.v1.ListNotificationsResponse.page:type_name -> chatto.api.v1.PageInfo
	6,  // 18: chatto.api.v1.GetNotificationResponse.notification:type_name -> chatto.api.v1.NotificationItem
	6,  // 19: chatto.api.v1.BatchGetNotificationsResponse.notifications:type_name -> chatto.api.v1.NotificationItem
	6,  // 20: chatto.api.v1.ListRoomNotificationsResponse.notifications:type_name -> chatto.api.v1.NotificationItem
	28, // 21: chatto.api.v1.ListRoomNotificationsResponse.page:type_name -> chatto.api.v1.PageInfo
	17, // 22: chatto.api.v1.ListRoomNotificationCountsResponse.room_counts:type_name -> chatto.api.v1.RoomNotificationCount
	7,  // 23: chatto.api.v1.NotificationService.ListNotifications:input_type -> chatto.api.v1.ListNotificationsRequest
	10, // 24: chatto.api.v1.NotificationService.GetNotification:input_type -> chatto.api.v1.GetNotificationRequest
	12, // 25: chatto.api.v1.NotificationService.BatchGetNotifications:input_type -> chatto.api.v1.BatchGetNotificationsRequest
	8,  // 26: chatto.api.v1.NotificationService.ListRoomNotifications:input_type -> chatto.api.v1.ListRoomNotificationsRequest
	18, // 27: chatto.api.v1.NotificationService.ListRoomNotificationCounts:input_type -> chatto.api.v1.ListRoomNotificationCountsRequest
	15, // 28: chatto.api.v1.NotificationService.HasNotifications:input_type -> chatto.api.v1.HasNotificationsRequest
	20, // 29: chatto.api.v1.NotificationService.DismissNotification:input_type -> chatto.api.v1.DismissNotificationRequest
	22, // 30: chatto.api.v1.NotificationService.DismissAllNotifications:input_type -> chatto.api.v1.DismissAllNotificationsRequest
	9,  // 31: chatto.api.v1.NotificationService.ListNotifications:output_type -> chatto.api.v1.ListNotificationsResponse
	11, // 32: chatto.api.v1.NotificationService.GetNotification:output_type -> chatto.api.v1.GetNotificationResponse
	13, // 33: chatto.api.v1.NotificationService.BatchGetNotifications:output_type -> chatto.api.v1.BatchGetNotificationsResponse
	14, // 34: chatto.api.v1.NotificationService.ListRoomNotifications:output_type -> chatto.api.v1.ListRoomNotificationsResponse
	19, // 35: chatto.api.v1.NotificationService.ListRoomNotificationCounts:output_type -> chatto.api.v1.ListRoomNotificationCountsResponse
	16, // 36: chatto.api.v1.NotificationService.HasNotifications:output_type -> chatto.api.v1.HasNotificationsResponse
	21, // 37: chatto.api.v1.NotificationService.DismissNotification:output_type -> chatto.api.v1.DismissNotificationResponse
	23, // 38: chatto.api.v1.NotificationService.DismissAllNotifications:output_type -> chatto.api.v1.DismissAllNotificationsResponse
