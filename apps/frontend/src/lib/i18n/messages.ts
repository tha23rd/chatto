...
const msg_voice_focus_feed = (): LocalizedString => messages().voice_focus_feed(empty());
const msg_voice_unfocus_feed = (): LocalizedString => messages().voice_unfocus_feed(empty());
const msg_voice_view_options = (): LocalizedString => messages().voice_view_options(empty());
const msg_voice_grid_view = (): LocalizedString => messages().voice_grid_view(empty());
const msg_voice_show_own_camera = (): LocalizedString => messages().voice_show_own_camera(empty());
const msg_voice_show_non_video_participants = (): LocalizedString => messages().voice_show_non_video_participants(empty());
const msg_voice_show_own_screen_share = (): LocalizedString => messages().voice_show_own_screen_share(empty());
...
const msg_voice_all_feeds_hidden = (): LocalizedString => messages().voice_all_feeds_hidden(empty());
const msg_voice_all_feeds_hidden_hint = (): LocalizedString => messages().voice_all_feeds_hidden_hint(empty());
const msg_voice_feed_not_watched = (): LocalizedString => messages().voice_feed_not_watched(empty());
const msg_voice_hide_own_camera = (): LocalizedString => messages().voice_hide_own_camera(empty());
const msg_voice_hide_own_screen_share = (): LocalizedString => messages().voice_hide_own_screen_share(empty());
const msg_voice_hide_participants = (): LocalizedString => messages().voice_hide_participants(empty());
const msg_voice_show_participants = (): LocalizedString => messages().voice_show_participants(empty());
const msg_voice_start_watching_feed = (): LocalizedString => messages().voice_start_watching_feed(empty());
const msg_voice_stop_watching_feed = (): LocalizedString => messages().voice_stop_watching_feed(empty());
...
export { msg_voice_focus_feed as 'voice.focus_feed' };
export { msg_voice_unfocus_feed as 'voice.unfocus_feed' };
export { msg_voice_view_options as 'voice.view_options' };
export { msg_voice_grid_view as 'voice.grid_view' };
export { msg_voice_show_own_camera as 'voice.show_own_camera' };
export { msg_voice_show_non_video_participants as 'voice.show_non_video_participants' };
export { msg_voice_show_own_screen_share as 'voice.show_own_screen_share' };
...
export { msg_voice_all_feeds_hidden as 'voice.all_feeds_hidden' };
export { msg_voice_all_feeds_hidden_hint as 'voice.all_feeds_hidden_hint' };
export { msg_voice_feed_not_watched as 'voice.feed_not_watched' };
export { msg_voice_hide_own_camera as 'voice.hide_own_camera' };
export { msg_voice_hide_own_screen_share as 'voice.hide_own_screen_share' };
export { msg_voice_hide_participants as 'voice.hide_participants' };
export { msg_voice_show_participants as 'voice.show_participants' };
export { msg_voice_start_watching_feed as 'voice.start_watching_feed' };
export { msg_voice_stop_watching_feed as 'voice.stop_watching_feed' };
