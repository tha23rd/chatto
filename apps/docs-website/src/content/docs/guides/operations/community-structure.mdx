...
When you add or remove a custom emoji, connected members receive the updated catalog immediately. Newly uploaded emoji can be used and rendered in messages and reactions without asking anyone to reload.
