...
| Reactions to your message | Notify you. All reactions on one message collapse into a single notification. |
...
| Normal | Notify for mentions, DMs, thread replies, and reactions to your own messages. |
| All messages | Notify for mentions, DMs, thread replies, reactions to your own messages, and every root message. |
