...
Fork-owned field. Upstream owns tags below 1000 and took tag 22 for `pinned`, so this field is numbered from the fork range. |
...
Fork-owned field. Upstream owns tags below 1000; this field was shipped at tag 23 in the fork's own main and is renumbered here to avoid the upstream tag space. |
