...
| `actions` | repeated [`MessageAction`](#chatto-api-v1-MessageAction) | Author-defined buttons that can send a named invocation back to the message author. |

<a id="chatto-api-v1-MessageAction"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `id` | `string` | Stable integration-defined ID within this message. |
| `label` | `string` | Visible button label. |
| `style` | [`MessageActionStyle`](#chatto-api-v1-MessageActionStyle) | Visual treatment. Unspecified uses the secondary treatment. |
| `disabled` | `bool` | Whether the button is visible but cannot currently be invoked. |

<a id="chatto-api-v1-MessageActionSet"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `actions` | repeated [`MessageAction`](#chatto-api-v1-MessageAction) | Ordered action buttons. IDs must be unique within the set. |
...
<a id="chatto-api-v1-MessageActionInvocation"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `id` | `string` | Caller-supplied idempotency key and stable invocation ID. |
| `room_id` | `string` | Room containing the message. |
| `message_event_id` | `string` | Canonical message event ID. Invocations made from a thread echo refer to the original message event. |
| `action_id` | `string` | Integration-defined action ID from the message. |
| `actor_id` | `string` | User who invoked the action. |
| `created_at` | `google.protobuf.Timestamp` | Time when Chatto accepted the invocation. |
...
<a id="chatto-api-v1-MessageActionStyle"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `MESSAGE_ACTION_STYLE_UNSPECIFIED` | `0` | Uses the normal secondary button treatment. |
| `MESSAGE_ACTION_STYLE_PRIMARY` | `1` | Emphasises the primary action. |
| `MESSAGE_ACTION_STYLE_SECONDARY` | `2` | Uses the normal secondary button treatment. |
| `MESSAGE_ACTION_STYLE_SUCCESS` | `3` | Indicates a successful or affirmative action. |
| `MESSAGE_ACTION_STYLE_DANGER` | `4` | Indicates a destructive or dangerous action. |
