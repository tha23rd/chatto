...
| Field | Type | Description |
| --- | --- | --- |
| `pinned_messages` | repeated [`PinnedMessage`](/reference/connectrpc-api/types/#chatto-api-v1-PinnedMessage) | Pinned messages in newest-pin-first order. |
| `page` | [`PageInfo`](/reference/connectrpc-api/types/#chatto-api-v1-PageInfo) | Page metadata. |
...
| Field | Type | Description |
| --- | --- | --- |
| `pinned_message` | [`PinnedMessage`](/reference/connectrpc-api/types/#chatto-api-v1-PinnedMessage) | Current pinned-message resource. Repeating an existing pin returns it. |
